...
if __name__ == "__main__":
    ...
    # ADD USER
    print("ADD USER")
    r = requests.post("http://127.0.0.1:2250/admin_console", data={"action": "addUser","username": username, "addname": "testuser", "email": "test@test.com"})
    print(r.text)
    print()

    # MODIFY USER
    print("MODIFY USER")
    r = requests.post("http://127.0.0.1:2250/admin_console", data={"action": "modifyUser", "username": username, "changeUser": "testuser", "group": "Secret"})
    print(r.text)
    print()

    # DELETE USER
    print("DELETE USER")
    r = requests.post("http://127.0.0.1:2250/admin_console", data={"action": "deleteUser", "username": username, "delUser": "testuser"})
    print(r.text)
    print()
